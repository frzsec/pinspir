...
import EventCarouselScreen from '@/components/game/EventCarouselScreen';
...
export default function GamePage() {
  return (
    <div className="min-h-[100dvh] w-full bg-[#EBF8EF] flex items-center justify-center font-nunitoSans selection:bg-emerald-200">
      {/* 
        Responsive device container (matching dashboard, chapter & progress)
      */}
      <div className="relative w-full max-w-[420px] h-[100dvh] sm:h-[880px] sm:max-h-[95vh] bg-[#311054] flex flex-col justify-between overflow-hidden shadow-2xl sm:rounded-3xl">
        
        {/* 3D Cover Flow Carousel Game Content */}
        ...
        <nav
          className="w-full bg-white rounded-t-[28px] shadow-[0_-6px_24px_rgba(0,0,0,0.07)] flex items-start justify-around pt-4 shrink-0 z-30"
          style={{
            minHeight: '84px',
        ...
        >
          ...
          {/* 3. Gamepad (Active: Green rounded pill) */}
          <button
            type="button"
